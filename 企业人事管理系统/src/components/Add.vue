<template>
  <div class="add container">
    <h1 class="page-header">添加员工</h1>
    	<router-link to="/" class="layui-btn layui-btn-sm"><i class="layui-icon"></i>&nbsp;返回</router-link> <br><br>
    <form v-on:submit="addCustomer">
        ...
        <div class="form-group">
    		...
    		<div class="form-group">
    			<label>个人简介</label>
    			<textarea class="form-control" rows="8" v-model="customer.profile"></textarea>
    		</div>
...
export default {
  ...
  methods:{
  	addCustomer(e){
  	  let flag = !this.customer.myid||!this.customer.name || !this.customer.sex || !this.customer.phone;
  		if (flag) {
